    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='custom_role', to='auth.group')),
            ],
            options={
                'db_table': 'roles',
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'users',
                'indexes': [models.Index(fields=['phone', 'username', 'fcm_token'], name='users_phone_e002b4_idx')],
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('createdAt', models.DateTimeField(auto_now_add=True, db_column='created_at')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='auth.permission')),
