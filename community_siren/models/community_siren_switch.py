...
class CommunitySirenSwitch(models.Model):
    """Model for Community Siren Switches"""
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=255)
    device = models.ForeignKey(
        Device,
        on_delete=models.CASCADE,
        related_name='community_siren_switches',
    ...
    image = models.ImageField(upload_to='community_siren_switches/', blank=True, null=True, help_text="Switch image")
