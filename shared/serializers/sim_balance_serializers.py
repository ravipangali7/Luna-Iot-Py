...
from shared.models import SimBalance, SimFreeResource
...
class SimBalanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'balance', 'balance_expiry', 'last_synced_at', 'free_resources',
            'created_at', 'updated_at'
        ]
...
class SimBalanceListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'balance_expiry', 'free_resources_count', 'last_synced_at', 'created_at'
        ]
