...
class SubscriptionPlanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'price', 'dealer_price', 'purchasing_price', 'permissions', 'permission_ids', 'created_at', 'updated_at']
...
class SubscriptionPlanListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubscriptionPlan
        fields = ['id', 'title', 'price', 'dealer_price', 'purchasing_price', 'permissions_count', 'created_at', 'updated_at']
