...
class SosStatus(models.Model):
    id = models.BigAutoField(primary_key=True)
    device = models.ForeignKey(Device, on_delete=models.CASCADE, related_name='sos_statuses', to_field='imei')
    ...
    def __str__(self):
        return f"SosStatus for {self.imei} - Battery: {self.battery}%, Signal: {self.signal}%"