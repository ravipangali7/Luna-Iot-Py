...
class BuzzerStatus(models.Model):
    id = models.BigAutoField(primary_key=True)
    device = models.ForeignKey(Device, on_delete=models.CASCADE, related_name='buzzer_statuses', to_field='imei')
    ...
    def __str__(self):
        return f"BuzzerStatus for {self.imei} - Battery: {self.battery}%, Signal: {self.signal}%"
